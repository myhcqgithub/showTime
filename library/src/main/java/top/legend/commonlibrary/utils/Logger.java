...
public final class Logger {
    ...
    private Logger() {
        throw new UnsupportedOperationException("I not instance,go home please...");
    }
    ...
    public static void init(Context context, LoggerConfig loggerConfig) {
        ...
        Logger.sLogSwitch = loggerConfig.logSwitch;
        Logger.sLog2ConsoleSwitch = loggerConfig.consoleSwitch;
        Logger.sGlobalTag = loggerConfig.tag;
        Logger.dir = loggerConfig.dir;
        Logger.sLogHeadSwitch = loggerConfig.logHeadSwitch;
        Logger.sLog2FileSwitch = loggerConfig.log2FileSwitch;
        Logger.sLogBorderSwitch = loggerConfig.borderSwitch;
        Logger.sTagIsSpace = loggerConfig.tagIsSpace;
        Logger.sConsoleFilter = loggerConfig.consoleFilter;
        Logger.sFileFilter = loggerConfig.fileFilter;

    }

    public static class LoggerConfig {
        private boolean logSwitch = Logger.sLogSwitch;
        private boolean consoleSwitch = Logger.sLog2ConsoleSwitch;
        private String tag = Logger.sGlobalTag;
        private String dir = Logger.dir;
        private boolean logHeadSwitch = Logger.sLogHeadSwitch;
        private boolean log2FileSwitch = Logger.sLog2FileSwitch;
        private boolean borderSwitch = Logger.sLogBorderSwitch;
        private boolean tagIsSpace = Logger.sTagIsSpace;
        private int consoleFilter = Logger.sConsoleFilter;
        private int fileFilter = Logger.sFileFilter;

        public LoggerConfig() {
//            if (defaultDir != null) return;
//            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
//                    && BaseApplication.getApp().getExternalCacheDir() != null)
//                defaultDir = BaseApplication.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
//            else {
//                defaultDir = BaseApplication.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
//            }
        }

        public LoggerConfig setLogSwitch(boolean logSwitch) {
            this.logSwitch = logSwitch;
            return this;
        }

        public LoggerConfig setConsoleSwitch(boolean consoleSwitch) {
            this.consoleSwitch = consoleSwitch;
            return this;
        }

        public LoggerConfig setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                this.tag = "";
        ...
        public LoggerConfig setLogHeadSwitch(boolean logHeadSwitch) {
            this.logHeadSwitch = logHeadSwitch;
            return this;
        }

        public LoggerConfig setLog2FileSwitch(boolean log2FileSwitch) {
            this.log2FileSwitch = log2FileSwitch;
            return this;
        }

        public LoggerConfig setDir(final String dir) {
            if (isSpace(dir)) {
                this.dir = null;
            } else {
        ...
        public LoggerConfig setDir(final File dir) {
            Logger.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public LoggerConfig setBorderSwitch(boolean borderSwitch) {
            this.borderSwitch = borderSwitch;
            return this;
        }

        public LoggerConfig setConsoleFilter(@TYPE int consoleFilter) {
            this.consoleFilter = consoleFilter;
            return this;
        }

        public LoggerConfig setFileFilter(@TYPE int fileFilter) {
...
//        }
//        printWriter.close(); +printWriter.toString()
        log(FILE | type, tag, contents + "\n");
    }
